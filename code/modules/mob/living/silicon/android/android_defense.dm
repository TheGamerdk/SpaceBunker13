//TODO: add damage reduction? (armor, combat androids, etc)

/mob/living/silicon/android/attackby(obj/item/I, mob/living/user)
	if(I.force && I.damtype != STAMINA && stat != DEAD) //only sparks if real damage is dealt.
		spark_system.start()
	return ..()

/* FIX FOR ALIENS!!
/mob/living/silicon/android/attack_alien(mob/living/carbon/alien/humanoid/M)
	...
	return
*/
/mob/living/silicon/android/attack_slime(mob/living/simple_animal/slime/M)
...
/mob/living/silicon/android/attack_hand(mob/living/carbon/human/user)
...
/mob/living/silicon/android/fire_act()
	if(!on_fire) //Silicons don't gain stacks from hotspots, but hotspots can ignite them
		IgniteMob()


/mob/living/silicon/android/emp_act(severity)
	switch(severity)
		if(1)
			Stun(160)
		if(2)
...
/* TODO: add emag stuff
/mob/living/silicon/android/emag_act(mob/user)
...
/mob/living/silicon/android/blob_act(obj/structure/blob/B)
	if(stat != DEAD)
		adjustBruteLoss(30)
	else
		gib()
...
/mob/living/silicon/android/ex_act(severity, target)
	switch(severity)
		if(1)
			gib()
			return
